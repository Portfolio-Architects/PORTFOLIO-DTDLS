...
export async function GET() {
  ...
  try {
    ...
    // Fallback: 기존 하드코딩 데이터 반환 (가나다순)
    const fallback: Record<string, string[]> = {
      '능동': ['직접 입력'],
      '목동': ['e편한세상 동탄', '힐스테이트 동탄'],
      '반송동': ['직접 입력'],
      '산척동': ['동탄 더샵 레이크에듀타운'],
      '석우동': ['직접 입력'],
      '송동': ['동탄린스트라우스더레이크', '동탄호수공원 아이파크'],
      '신동': ['직접 입력'],
      '여울동': ['동탄역 반도유보라 아이비파크 6.0', '동탄역 반도유보라 아이비파크 7.0', '동탄역 반도유보라 아이비파크 8.0', '동탄역 롯데캐슬', '동탄역 파라곤'],
      '영천동': ['동탄 파크자이', '동탄역 센트럴푸르지오'],
      '장지동': ['직접 입력'],
      '청계동': ['동탄역 시범더샵 센트럴시티', '동탄역 시범우남 퍼스트빌', '동탄역 시범한화 꿈에그린 프레스티지'],
      '기타': ['직접 입력']
    };
