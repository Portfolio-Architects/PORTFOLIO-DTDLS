...
// Fallback Database for when API is unavailable (가나다순 정렬)
const FALLBACK_DONG_DATA: Record<string, string[]> = {
  '능동': ['직접 입력'],
  '목동 (중동탄)': ['e편한세상 동탄', '동탄 금강펜테리움 4차', '동탄 한신더휴', '동탄2 호반베르디움 센트럴포레', '힐스테이트 동탄'],
  '반송동': ['직접 입력'],
  '산척동 (호수공원)': ['동탄 금강펜테리움 센트럴파크 2차', '동탄 더샵 레이크에듀타운', '동탄 반도유보라 아이비파크 10.0'],
  '석우동': ['직접 입력'],
  '송동 (남동탄/호수공원)': ['동탄 부영 3단지', '동탄 부영 4단지', '동탄린스트라우스더레이크', '동탄호수공원 아이파크', '우미린 스트라우스 더 레이크'],
  '신동': ['직접 입력'],
  '여울동 (동탄역)': ['동탄역 반도유보라 아이비파크 6.0', '동탄역 반도유보라 아이비파크 7.0', '동탄역 반도유보라 아이비파크 8.0', '동탄역 예미지 시그너스', '동탄역 파라곤', '동탄역 롯데캐슬'],
  '영천동 (북동탄)': ['동탄 파크자이', '동탄역 더샵센트럴시티 2차', '동탄역 센트럴푸르지오', '동탄역 푸르지오시티'],
  '장지동': ['직접 입력'],
