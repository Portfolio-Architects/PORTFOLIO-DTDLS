      ...
      <div className="p-5 flex flex-col gap-5">
          ...
          {AREA_CONFIG.map(area => (
            <div key={area.key} className="flex items-center gap-3">
              ...
              <input
                ...
                className="flex-1 h-1.5 bg-[#e5e8eb] rounded-lg appearance-none cursor-pointer accent-[#00d29d]"
              />
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-3">
            {/* Score Result */}
            <div className="bg-gradient-to-r from-[#8b5cf6]/10 to-[#00d29d]/10 rounded-2xl p-4 text-center border border-[#8b5cf6]/20">
