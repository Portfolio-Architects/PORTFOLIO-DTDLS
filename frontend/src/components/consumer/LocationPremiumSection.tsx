  ...
  return (
    <div className="mb-6">
      <div className="flex items-center gap-2 mb-4">
        <h3 className="text-[16px] font-bold text-primary">입지 프리미엄 분석</h3>
      </div>

      <div className="bg-surface border border-border shadow-sm rounded-2xl p-5">
        {/* Total Score Banner */}
        <div className="flex items-center justify-between p-4 bg-body rounded-xl mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-surface shadow-sm flex items-center justify-center text-[#f59e0b]">
              <Trophy size={20} />
            </div>
            <div>
              <div className="text-[12px] font-bold text-tertiary mb-0.5">입지 종합 점수</div>
            ...
            <div key={m.key}>
              <div className="flex justify-between items-center mb-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[13px] font-bold text-secondary">{m.label}</span>
                </div>
