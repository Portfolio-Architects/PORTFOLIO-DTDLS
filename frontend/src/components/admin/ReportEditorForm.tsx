...
const IMAGE_CATEGORY_GROUPS: { group: string; items: string[] }[] = [
  ...
  { group: '🚪 문주·출입구', items: ['정문 (메인게이트)', '후문/측문', '차량 출입구', '보행자 출입구'] },
  { group: '🌿 조경·외부', items: ['중앙 조경', '산책로/보행로', '수경시설 (분수/연못)', '놀이터', '운동기구/트랙', '정원/화단'] },
  ...
  { group: '🏙️ 주변 환경', items: ['역세권/교통 접근성', '통학로/학교', '주변 상권', '소음 환경 (도로)', '관리사무소', '분리수거장/쓰레기', '단지 내 상가', '기타'] },
];
