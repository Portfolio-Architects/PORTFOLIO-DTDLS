...
export const DONGS: DongInfo[] = [
  { id: 'cheonggyedong', name: '청계동', color: '#0d9488', emoji: '🏙️', description: '동탄역 시범단지 밀집, 학군·상권 최강 지역' },
  ...
  { id: 'sancheok',    name: '산척동', color: '#0d9488', emoji: '🏫', description: '호수공원역 주변, 교육·자연 인프라 우수' },
